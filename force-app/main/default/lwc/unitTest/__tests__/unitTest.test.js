...
describe('c-unit-test', () => {
    ...
    it('displays unit status with updated unitNumnber', () =>{
        const element = createElement('c-unit-test', {
            is: UnitTest
        });
        ...
        // Add the element to the jsdom instance
        document.body.appendChild(element);
        // Update unit number after element is appended
        element.unitNumber = 6;

        const div = element.shadowRoot.querySelector('div');
        // Return a promise to wait for any asynchronous DOM updates. Jest will automatically
        // wait for the Promise chain to complete before ending the test and fail the test 
